...
- Game pauses wehn contact form window is open.
...
To deploy Amy Buckley Fitness to GitHub Pages from its [GitHub repository](https://github.com/dof-bull/ci_milestone_project_2_noahs_ark_animal_roundup), the following steps were taken: 
1. Log into GitHub. 
...
### Content
Web Dev Simplified and PortEXE for their tutorials which form a strong base of this project.
